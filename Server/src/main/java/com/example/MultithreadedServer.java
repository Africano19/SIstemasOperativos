...
// Importa o Logger e LoggerFactory
...
public class MultithreadedServer {
    ...
    public static void main(String[] args) throws IOException {
        // Define o Logger
        Logger logger = LoggerFactory.getLogger(MultithreadedServer.class);
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            // Registra qualquer erro que ocorrer com o servidor
    ...
    static class ServerThread extends Thread {
        ...
        public void run() {
            try {
                ...
                // Registra qualquer erro que ocorrer com o thread
                logger.error("Server exception: " + ex.getMessage(), ex);
            }
        }
    }
